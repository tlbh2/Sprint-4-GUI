...
TEST_F(cMainTest, AC_8_1)
{
	vector < vector < string>> temp_2d_matrix = { {"S", " ", " "} ,
												  {" ", "O", " "} ,
												  {" ", " ", "S"} };
	pair<int, int> temp;
	cMain_object->Set_AI_label();
	temp = cMain_object->AI_placement_on_2d_matrix(temp_2d_matrix);
	EXPECT_EQ("S", cMain_object->Get_AI_Label());
}

TEST_F(cMainTest, AC_8_2)
{
	vector < vector < string>> temp_2d_matrix = { {"S", " ", " "} ,
												  {" ", "O", " "} ,
												  {" ", " ", "S"} };
